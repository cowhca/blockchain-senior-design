...
export class MsgClientImpl {
    ...
    SendCreatePair(request) {
        ...
        const promise = this.rpc.request("cosmonaut.interchange.dex.Msg", "SendCreatePair", data);
    ...
    SendSellOrder(request) {
        ...
        const promise = this.rpc.request("cosmonaut.interchange.dex.Msg", "SendSellOrder", data);
    ...
    SendBuyOrder(request) {
        ...
        const promise = this.rpc.request("cosmonaut.interchange.dex.Msg", "SendBuyOrder", data);
    ...
    CancelSellOrder(request) {
        ...
        const promise = this.rpc.request("cosmonaut.interchange.dex.Msg", "CancelSellOrder", data);
    ...
    CancelBuyOrder(request) {
        ...
        const promise = this.rpc.request("cosmonaut.interchange.dex.Msg", "CancelBuyOrder", data);
