...
import CosmonautInterchangeCosmonautInterchangeDex from './cosmonaut/interchange/cosmonaut.interchange.dex'
...
export default { 
  CosmonautInterchangeCosmonautInterchangeDex: load(CosmonautInterchangeCosmonautInterchangeDex, 'cosmonaut.interchange.dex'),
